...
In her study of Gary dart point morphology, Densmore [-@RN20874] employed an angle measurement between the stem and shoulder of each point. This study will use a modified approach to ensure that the angle calculations remain consistent across the sample, by calculating the angle using LMs 2, 4, and 6. This provides a means of data collection that is consistent and replicable across the entirety of the sample.
